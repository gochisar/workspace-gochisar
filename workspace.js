...
cprequire_test(["inline:com-chilipeppr-workspace-antbarney"], function(ws) {
    ...
    $('title').html("antbarney Workspace");
    $('body').css('padding', '10px');

} /*end_test*/ );

// This is the main definition of your widget. Give it a unique name.
cpdefine("inline:com-chilipeppr-workspace-antbarney", ["chilipeppr_ready"], function() {
    return {
        /**
         * The ID of the widget. You must define this and make it unique.
         */
        id: "com-chilipeppr-workspace-antbarney", // Make the id the same as the cpdefine id
        name: "Workspace / antbarney", // The descriptive name of your widget.
        desc: `A ChiliPeppr Workspace for me.`,
        ...
        init: function() {
            ...
            ////////// Load all of the TinyG Widgets
            this.loadZipWipWidget();
            this.loadAutoLevelWidget();
            this.loadMacroWidget();
            this.loadJScutWidget();
            this.loadLaserSolderWidget();
            this.loadHWFlashWidget();
            this.loadGcodehWidget();
            //this.loadBilboardWidget();
            this.load3DViewerWidget();
            this.loadGcodeListv3Widget();
            this.loadXYZWidget();
        ...
        loadZipWipWidget: function(callback) {
        ...
        "http://raw.githubusercontent.com/chilipeppr/com-chilipeppr-widget-macro/master/auto-generated-widget.html", function () {
        ...
        // Laser Solder
        // com-chilipeppr-ws-jscut
        loadLaserSolderWidget: function(callback) {
        chilipeppr.load(
        ...
        loadHWFlashWidget: function(callback) {
        chilipeppr.load(
        ...
        loadGcodehWidget: function(callback) {
        ...
        loadBilboardWidget: function(callback) {
        chilipeppr.load(
        ...
        loadGcodeListv3Widget: function(callback){
        ...
        loadWebRTCClientWidget: function(callback){
        chilipeppr.load(
