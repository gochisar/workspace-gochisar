...
cprequire_test(["inline:com-chilipeppr-workspace-gochisar"], function(ws) {
    ...
    $('title').html("gochisar Workspace");
    $('body').css('padding', '10px');

} /*end_test*/ );

// This is the main definition of your widget. Give it a unique name.
cpdefine("inline:com-chilipeppr-workspace-gochisar", ["chilipeppr_ready"], function() {
    return {
        /**
         * The ID of the widget. You must define this and make it unique.
         */
        id: "com-chilipeppr-workspace-gochisar", // Make the id the same as the cpdefine id
        name: "Workspace / gochisar", // The descriptive name of your widget.
